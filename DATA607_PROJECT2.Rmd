...
### Importing data
```{r}
df <- read.csv("https://raw.githubusercontent.com/GabrielSantos33/DATA607_Project_02/main/2015y_Banqiao_Station.csv", stringsAsFactors = FALSE)
str(df)
```
...
library(RCurl)
library(tibble)
url <- getURL("https://raw.githubusercontent.com/GabrielSantos33/DATA607_Project_02/main/indicator%20hiv%20estimated%20prevalence_%2015-49.csv")
